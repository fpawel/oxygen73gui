...
begin
    ...
    FSelectedBucket.UpdatedAt := DateTimeToUnixMillis(IncHour(now, 3));
...
begin
    ...
    if Length(ms.Measurements) = 0 then
    begin
        FormProducts.RedrawAmbient;
        for I := 0 to 49 do
            FormProducts.RedrawPlace(I);
        FormOxygen73.HideModalPanel;
        FormChart.Show;
        exit;
    end;
...
begin
    ...
    FormOxygen73.ShowModalPanel(Format('Открывается график %d',
